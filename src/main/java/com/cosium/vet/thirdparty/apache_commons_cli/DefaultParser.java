 ...
 */
package com.cosium.vet.thirdparty.apache_commons_cli;
...
public class DefaultParser implements CommandLineParser {
  ...
  /**
   * Flag indicating how unrecognized tokens are handled. <tt>true</tt> to stop the parsing and add
   * the remaining tokens to the args list. <tt>false</tt> to throw an exception.
   */
   ...
   * }</pre>
   *
   * with "partial matching" turned on, <code>-de</code> only matches the <code>"debug"</code>
   * option. However, with "partial matching" disabled, <code>-de</code> would enable both <code>
   * debug</code> as well as <code>extract</code> options.
   */
  ...
  /**
   * Throw a {@link MissingArgumentException} if the current option didn't receive the number of
   * arguments expected.
   */
  ...
  /**
   * Returns a list of matching option strings for the given token, depending on the selected
