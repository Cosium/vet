...
public class Charsets {
   ...
   */
  @Deprecated public static final Charset ISO_8859_1 = Charset.forName("ISO-8859-1");
  /**
   ...
   * @deprecated Use Java 7's {@link java.nio.charset.StandardCharsets}
   */
  @Deprecated public static final Charset US_ASCII = Charset.forName("US-ASCII");
  /**
   ...
   * @deprecated Use Java 7's {@link java.nio.charset.StandardCharsets}
   */
  @Deprecated public static final Charset UTF_16 = Charset.forName("UTF-16");
  /**
   * Sixteen-bit Unicode Transformation Format, big-endian byte order.
   *
   * <p>Every implementation of the Java platform is required to support this character encoding.
   ...
   * @deprecated Use Java 7's {@link java.nio.charset.StandardCharsets}
   */
  @Deprecated public static final Charset UTF_16BE = Charset.forName("UTF-16BE");
  /**
   * Sixteen-bit Unicode Transformation Format, little-endian byte order.
   *
   * <p>Every implementation of the Java platform is required to support this character encoding.
   ...
   * @deprecated Use Java 7's {@link java.nio.charset.StandardCharsets}
   */
  @Deprecated public static final Charset UTF_16LE = Charset.forName("UTF-16LE");
  /**
   * Eight-bit Unicode Transformation Format.
   *
   * <p>Every implementation of the Java platform is required to support this character encoding.
   ...
   * @deprecated Use Java 7's {@link java.nio.charset.StandardCharsets}
   */
  @Deprecated public static final Charset UTF_8 = Charset.forName("UTF-8");
