 ...
 */
package com.cosium.vet.thirdparty.apache_commons_io.filefilter;
 ...
 * @version $Id$
 * @since 1.1
 * @deprecated Use WilcardFileFilter. Deprecated as this class performs directory filtering which it
 *     shouldn't do, but that can't be removed due to compatability.
 */
@Deprecated
