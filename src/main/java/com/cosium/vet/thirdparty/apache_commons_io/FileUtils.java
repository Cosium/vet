 ...
 */
package com.cosium.vet.thirdparty.apache_commons_io;

import com.cosium.vet.thirdparty.apache_commons_io.filefilter.*;
import com.cosium.vet.thirdparty.apache_commons_io.output.NullOutputStream;
...
public class FileUtils {
   ...
   * @see com.cosium.vet.thirdparty.apache_commons_io.filefilter.FileFilterUtils
   * @see com.cosium.vet.thirdparty.apache_commons_io.filefilter.NameFileFilter
   */
   ...
   *     TrueFileFilter.INSTANCE to match all directories.
   * @return an collection of java.io.File with the matching files
   * @see com.cosium.vet.thirdparty.apache_commons_io.FileUtils#listFiles
   * @see com.cosium.vet.thirdparty.apache_commons_io.filefilter.FileFilterUtils
   * @see com.cosium.vet.thirdparty.apache_commons_io.filefilter.NameFileFilter
   * @since 2.2
   */
  ...
  public static void copyFileToDirectory(
      final File srcFile, final File destDir, final boolean preserveFileDate) throws IOException {
    if (destDir == null) {
