 ...
 */
package com.cosium.vet.thirdparty.apache_commons_io.output;

import com.cosium.vet.thirdparty.apache_commons_io.input.XmlStreamReader;
...
public class XmlStreamWriter extends Writer {
  ...
  /**
   * Construct an new XML stream writer for the specified output stream with a default encoding of
   * UTF-8.
   *
  ...
  /**
   * Construct an new XML stream writer for the specified output stream with the specified default
   * encoding.
   *
   * @param out The output stream
