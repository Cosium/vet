...
public class LineIterator implements Iterator<String> {
   ...
   * process the first few lines of a larger file. If you do not close the iterator then the <code>
   * Reader</code> remains open. This method can safely be called multiple times.
   */
  public void close() {
    finished = true;
