 ...
 */
package com.cosium.vet.thirdparty.apache_commons_io.input;

import com.cosium.vet.thirdparty.apache_commons_io.ByteOrderMark;
...
/**
 * Character stream that handles all the necessary Voodo to figure out the charset encoding of the
 ...
 * can be used for an script (following HTTP MIME and XML specifications). All this is nicely
 ...
 *
 * @version $Id$
 * @see com.cosium.vet.thirdparty.apache_commons_io.output.XmlStreamWriter
 * @since 2.0
 */
public class XmlStreamReader extends Reader {
  ...
  /**
   * Creates a Reader using an InputStream an the associated content-type header. This constructor
