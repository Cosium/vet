 ...
 */
package com.cosium.vet.thirdparty.apache_commons_lang3.math;
 ...
 *
 * <p>This class is immutable, and interoperable with most methods that accept a <code>Number</code>
 * .
 *
...
public final class Fraction extends Number implements Comparable<Fraction> {
   ...
   * @throws ArithmeticException if the denominator is <code>zero</code> or the denominator is
   *     {@code negative} and the numerator is {@code Integer#MIN_VALUE}
   */
   ...
   * @throws ArithmeticException if <code>|value| &gt; Integer.MAX_VALUE</code> or <code>value = NaN
   *     </code>
  ...
  /**
   * Gets the fraction as a <code>float</code>. This calculates the fraction as the numerator
  ...
  /**
   * Gets the fraction as a <code>double</code>. This calculates the fraction as the numerator
   * divided by denominator.
   *
   ...
   *
   * <p>More precisely: <code>(fraction &gt;= 0 ? this : -fraction)</code>
   *
   * <p>The returned fraction is not reduced.
   *
   * @return <code>this</code> if it is positive, or a new positive fraction instance with the
   ...
   * @return <code>this</code> if the power is one, <code>ONE</code> if the power is zero (even if
   *     the fraction equals ZERO) or a new fraction instance raised to the appropriate power
