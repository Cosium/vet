 ...
 *     href="https://commons.apache.org/proper/commons-text/javadocs/api-release/org/apache/commons/text/StrLookup.html">
 *     StrLookup</a> instead
 */
@Deprecated
public abstract class StrLookup<V> {
  ...
  /**
   * Returns a new lookup which uses a copy of the current {@link System#getProperties() System
   * properties}.
   *
   * <p>If a security manager blocked access to system properties, then null will be returned from
   * every lookup.
   *
   * <p>If a null key is used, this lookup will throw a NullPointerException.
   *
   ...
   *
   * <p>If the map is null, then null will be returned from every lookup. The map result object is
   ...
   *
   * <p>The {@link #lookup(String)} method always returns a String, regardless of the underlying
   * data, by converting it as necessary. For example:
   *
   * <pre>
  ...
  static class MapStrLookup<V> extends StrLookup<V> {
     ...
     *
     * <p>If the map is null, then null is returned. The map result object is converted to a string
     * using toString().
     *
     * @param key the key to be looked up, may be null
     * @return the matching value, null if no match
