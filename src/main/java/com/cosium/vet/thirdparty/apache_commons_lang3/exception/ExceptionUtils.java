 ...
 */
package com.cosium.vet.thirdparty.apache_commons_lang3.exception;
...
public class ExceptionUtils {
   ...
   *
   * <p>The method searches for methods with specific names that return a <code>Throwable</code>
   * object. This will pick up most wrapping exceptions, including those from JDK 1.4.
   *
   ...
   * Introspects the <code>Throwable</code> to obtain the cause.
   *
   * <p>A <code>null</code> set of method names means use the default set. A <code>null</code> in
   * the set of method names will be ignored.
   *
   * @param throwable the throwable to introspect for a cause, may be null
   ...
   *
   * <p>A throwable without cause will return <code>1</code>. A throwable with one cause will return
   * <code>2</code> and so on. A <code>null</code> throwable will return <code>0</code>.
   *
   * <p>From version 2.2, this method handles recursive cause structures that might otherwise cause
   ...
   * the cause throwable. A <code>null</code> throwable will return a list of size zero.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Returns the (zero based) index of the first <code>Throwable</code> that matches the specified
   * class (exactly) in the exception chain. Subclasses of the specified class do not match - see
   * {@link #indexOfType(Throwable, Class)} for the opposite.
   *
   * <p>A <code>null</code> throwable returns <code>-1</code>. A <code>null</code> type returns
   * <code>-1</code>. No match in the chain returns <code>-1</code>.
   *
   * @param throwable the throwable to inspect, may be null
  ...
  /**
   * Returns the (zero based) index of the first <code>Throwable</code> that matches the specified
   * type in the exception chain from a specified index. Subclasses of the specified class do not
   * match - see {@link #indexOfType(Throwable, Class, int)} for the opposite.
   *
   * <p>A <code>null</code> throwable returns <code>-1</code>. A <code>null</code> type returns
   * <code>-1</code>. No match in the chain returns <code>-1</code>. A negative start index is
   * treated as zero. A start index greater than the number of throwables returns <code>-1</code>.
   *
   * @param throwable the throwable to inspect, may be null
   * @param clazz the class to search for, subclasses do not match, null returns -1
  ...
  public static int indexOfThrowable(
      final Throwable throwable, final Class<?> clazz, final int fromIndex) {
  ...
  /**
   * Returns the (zero based) index of the first <code>Throwable</code> that matches the specified
   * class or subclass in the exception chain. Subclasses of the specified class do match - see
  ...
  /**
   * Returns the (zero based) index of the first <code>Throwable</code> that matches the specified
   * type in the exception chain from a specified index. Subclasses of the specified class do match
   * - see {@link #indexOfThrowable(Throwable, Class)} for the opposite.
   *
   * <p>A <code>null</code> throwable returns <code>-1</code>. A <code>null</code> type returns
   * <code>-1</code>. No match in the chain returns <code>-1</code>. A negative start index is
   * treated as zero. A start index greater than the number of throwables returns <code>-1</code>.
  ...
  public static int indexOfType(
      final Throwable throwable, final Class<?> type, final int fromIndex) {
   ...
   * @return index of the <code>type</code> within throwables nested within the specified <code>
   *     throwable</code>
   */
  private static int indexOf(
      final Throwable throwable, final Class<?> type, int fromIndex, final boolean subclass) {
  ...
  // -----------------------------------------------------------------------
  /**
   * Prints a compact stack trace for the root cause of a throwable to <code>System.err</code>.
   *
   ...
   *
   * <p>The method is equivalent to <code>printStackTrace</code> for throwables that don't have
   * nested causes.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Creates a compact stack trace for the root cause of the supplied <code>Throwable</code>.
   *
