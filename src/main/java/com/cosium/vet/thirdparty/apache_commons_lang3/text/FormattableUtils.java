 ...
 *
 * <p>The {@link Formattable} interface provides basic control over formatting when using a {@code
 * Formatter}. It is primarily concerned with numeric precision and padding, and is not designed to
 * allow generalised alternate formats.
 *
 * @since Lang 3.0
 * @deprecated as of 3.6, use commons-text <a
 *     href="https://commons.apache.org/proper/commons-text/javadocs/api-release/org/apache/commons/text/FormattableUtils.html">
...
public class FormattableUtils {
  ...
  /**
   * {@code FormattableUtils} instances should NOT be constructed in standard programming. Instead,
   * the methods of the class should be invoked statically.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Get the default formatted representation of the specified {@code Formattable}.
   *
  ...
  /**
   * Handles the common {@code Formattable} operations of truncate-pad-append, with no ellipsis on
   * precision overflow, and padding width underflow with spaces.
   *
  ...
  /**
   * Handles the common {@link Formattable} operations of truncate-pad-append, with no ellipsis on
   * precision overflow.
   *
   * @param seq the string to handle, not null
   * @param formatter the destination formatter, not null
  ...
  /**
   * Handles the common {@link Formattable} operations of truncate-pad-append, padding width
   * underflow with spaces.
   *
   * @param seq the string to handle, not null
   * @param formatter the destination formatter, not null
   * @param flags the flags for formatting, see {@code Formattable}
   * @param width the width of the output, see {@code Formattable}
   * @param precision the precision of the output, see {@code Formattable}
   * @param ellipsis the ellipsis to use when precision dictates truncation, null or empty causes a
   *     hard truncation
   * @return the {@code formatter} instance, not null
   */
  public static Formatter append(
