 ...
 * However {@link com.cosium.vet.thirdparty.apache_commons_lang3.CharSet} is not currently guaranteed thread-safe under all circumstances.</p>
 *
 * <p>The top level package contains various Utils classes, whilst there are various subpackages including {@link com.cosium.vet.thirdparty.apache_commons_lang3.math}, {@link com.cosium.vet.thirdparty.apache_commons_lang3.concurrent} and {@link com.cosium.vet.thirdparty.apache_commons_lang3.builder}.
 ...
 * The first is {@link com.cosium.vet.thirdparty.apache_commons_lang3.StringUtils}, oodles and oodles of functions which tweak, transform, squeeze and cuddle {@link java.lang.String java.lang.Strings}.
 * In addition to StringUtils, there are a series of other String manipulating classes; {@link com.cosium.vet.thirdparty.apache_commons_lang3.RandomStringUtils} and {@link com.cosium.vet.thirdparty.apache_commons_lang3.StringEscapeUtils StringEscapeUtils}.
 ...
 * StringUtils' {@link com.cosium.vet.thirdparty.apache_commons_lang3.StringUtils#capitalize(String)}, {@link com.cosium.vet.thirdparty.apache_commons_lang3.StringUtils#substringBetween(String, String)}/{@link com.cosium.vet.thirdparty.apache_commons_lang3.StringUtils#substringBefore(String, String) Before}/{@link com.cosium.vet.thirdparty.apache_commons_lang3.StringUtils#substringAfter(String, String) After}, {@link com.cosium.vet.thirdparty.apache_commons_lang3.StringUtils#split(String)} and {@link com.cosium.vet.thirdparty.apache_commons_lang3.StringUtils#join(Object[])} are good methods to begin with.</p>
 *
 ...
 * {@link com.cosium.vet.thirdparty.apache_commons_lang3.CharUtils} exists for this purpose, while {@link com.cosium.vet.thirdparty.apache_commons_lang3.CharSetUtils} exists for set-manipulation of Strings.
 ...
 *
 * <p>{@link com.cosium.vet.thirdparty.apache_commons_lang3.CharRange} and {@link com.cosium.vet.thirdparty.apache_commons_lang3.CharSet} are both used internally by CharSetUtils, and will probably rarely be used.</p>
 *
 ...
 *
 * <p>The {@link com.cosium.vet.thirdparty.apache_commons_lang3.CharEncoding} class is also used to interact with the Java environment and may be used to see which character encodings are supported in a particular environment. </p>
 *
 ...
 *
 * <p>Would you believe it, {@link com.cosium.vet.thirdparty.apache_commons_lang3.ObjectUtils} contains handy functions for Objects, mainly null-safe implementations of the methods on {@link java.lang.Object}.</p>
 *
 * <p>{@link com.cosium.vet.thirdparty.apache_commons_lang3.ClassUtils} is largely a set of helper methods for reflection.
 ...
 *
 * <p>Next up, {@link com.cosium.vet.thirdparty.apache_commons_lang3.ArrayUtils}.
 ...
 * </ul>
 *
 * <p>Lastly, {@link com.cosium.vet.thirdparty.apache_commons_lang3.ArrayUtils#toMap(Object[])} is worthy of special note.
 ...
 * It contains various Boolean acting methods, probably of most interest is the {@link com.cosium.vet.thirdparty.apache_commons_lang3.BooleanUtils#toBoolean(String)} method which turns various positive/negative Strings into a Boolean object, and not just true/false as with Boolean.valueOf.</p>
 *
 ...
 * <p>The {@link com.cosium.vet.thirdparty.apache_commons_lang3.BitField} class provides a wrapper class around the classic bitmask integer, whilst the {@link com.cosium.vet.thirdparty.apache_commons_lang3.Validate} class may be used for assertions (remember, we support Java 1.2). </p>
 *
 * @since 1.0
 */
