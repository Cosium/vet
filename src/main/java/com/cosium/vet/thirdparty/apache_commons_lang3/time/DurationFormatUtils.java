...
public class DurationFormatUtils {
  ...
  /**
   * Pattern used with <code>FastDateFormat</code> and <code>SimpleDateFormat</code> for the ISO
   * 8601 period format used in durations.
   *
   * @see com.cosium.vet.thirdparty.apache_commons_lang3.time.FastDateFormat
