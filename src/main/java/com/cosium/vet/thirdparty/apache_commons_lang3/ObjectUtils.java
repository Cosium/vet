...
import com.cosium.vet.thirdparty.apache_commons_lang3.exception.CloneFailedException;
import com.cosium.vet.thirdparty.apache_commons_lang3.mutable.MutableInt;
import com.cosium.vet.thirdparty.apache_commons_lang3.text.StrBuilder;
 ...
 * thrown for a {@code null} input. Each method documents its behaviour in more detail.
 *
 * <p>#ThreadSafe#
 *
 * @since 1.0
...
public class ObjectUtils {
   ...
   *
   * <p>For example, in a {@code HashMap} the {@link HashMap#get(Object)} method returns {@code
   * null} if the {@code Map} contains {@code null} or if there is no matching key. The {@code Null}
