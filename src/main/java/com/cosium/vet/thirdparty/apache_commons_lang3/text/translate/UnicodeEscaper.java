...
public class UnicodeEscaper extends CodePointTranslator {
  ...
  /**
   * Constructs a <code>UnicodeEscaper</code> for the specified range. This is the underlying method
   * for the other constructors/builders. The <code>below</code> and <code>above</code> boundaries
   * are inclusive when <code>between</code> is <code>true</code> and exclusive when it is <code>
   * false</code>.
   *
