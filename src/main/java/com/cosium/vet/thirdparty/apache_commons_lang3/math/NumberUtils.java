...
public class NumberUtils {
   ...
   *
   * <p>Then, the value is examined for a type qualifier on the end, i.e. one of <code>
   * 'f','F','d','D','l','L'</code>. If it is found, it starts trying to create successively larger
   * types from the type specified until one is found that can represent the value.
   *
  ...
  /**
   * Convert a <code>String</code> to a <code>Integer</code>, handling hex (0xhhhh) and octal
   * (0dddd) notations. N.B. a leading zero means octal; spaces are not trimmed.
   *
   * <p>Returns <code>null</code> if the string is <code>null</code>.
   *
   * @param str a <code>String</code> to convert, may be null
  ...
  /**
   * Convert a <code>String</code> to a <code>Long</code>; since 3.1 it handles hex (0Xhhhh) and
   * octal (0ddd) notations. N.B. a leading zero means octal; spaces are not trimmed.
   *
   * <p>Returns <code>null</code> if the string is <code>null</code>.
   *
   * @param str a <code>String</code> to convert, may be null
   ...
   *
   * <p>Valid numbers include hexadecimal marked with the <code>0x</code> or <code>0X</code>
   ...
   * string <code>09</code> will return <code>false</code>, since <code>9</code> is not a valid
   * octal value. However, numbers beginning with {@code 0.} are treated as decimal.
   *
   * <p><code>null</code> and empty/blank {@code String} will return <code>false</code>.
   *
