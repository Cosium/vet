...
import com.cosium.vet.thirdparty.apache_commons_lang3.mutable.MutableObject;
...
public class ClassUtils {
   ...
   *
   * <p>Consider using the Java 5 API {@link Class#getSimpleName()} instead. The one known
   * difference is that this code will return {@code "Map.Entry"} while the {@code java.lang.Class}
   ...
   *
   * <p>Note that this method differs from Class.getSimpleName() in that this will return {@code
   * "Map.Entry"} whilst the {@code java.lang.Class} variant will simply return {@code "Entry"}.
   *
   ...
   * space is available, rightmost sub-packages will be displayed in full length.
   *
  ...
  public static boolean isAssignable(final Class<?>[] classArray, final Class<?>... toClassArray) {
    return isAssignable(
        classArray, toClassArray, SystemUtils.isJavaVersionAtLeast(JavaVersion.JAVA_1_5));
  }
  ...
  /**
   * Get an {@link Iterable} that can iterate over a class hierarchy in ascending (subclass to
