...
import com.cosium.vet.thirdparty.apache_commons_lang3.arch.Processor;

import java.util.HashMap;
import java.util.Map;

/**
 * An utility class for the os.arch System Property. The class defines methods for identifying the
 * architecture of the current JVM.
 *
 * <p>Important: The os.arch System Property returns the architecture used by the JVM not of the
 * operating system.
 *
 * @since 3.6
 */
