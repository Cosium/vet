 ...
 * Java</a> , by Joshua Bloch. In particular the rule for comparing <code>doubles</code>, <code>
 * floats</code>, and arrays can be tricky. Also, making sure that <code>equals()</code> and <code>
 * hashCode()</code> are consistent can be difficult.
 *
 ...
 * slower than testing explicitly. Non-primitive fields are compared using <code>equals()</code>.
 *
 ...
 * <code>reflectionEquals</code> methods.
 *
 * @since 1.0
 */
public class EqualsBuilder implements Builder<Boolean> {
  ...
  /**
   * Returns <code>true</code> if the registry contains the given object pair. Used by the
   ...
   * the specified superclass. A null superclass is treated as java.lang.Object.
   *
   * <p>If the testRecursive parameter is set to <code>true</code>, non primitive (and non primitive
   * wrapper) field types will be compared by <code>EqualsBuilder</code> recursively instead of
   * invoking their <code>equals()</code> method. Leading to a deep reflection equals test.
   *
   * @param lhs <code>this</code> object
   * @param rhs the other object
   * @param testTransients whether to include transient fields
   ...
   * Non-primitive fields are compared using <code>equals()</code>.
   *
   * <p>If the testTransients field is set to <code>true</code>, transient members will be tested,
   * otherwise they are ignored, as they are likely derived fields, and not part of the value of the
   * <code>Object</code>.
   *
   * <p>Static fields will not be included. Superclass fields will be appended up to and including
   * the specified superclass in field <code>reflectUpToClass</code>. A null superclass is treated
   * as java.lang.Object.
   *
   * <p>Field names listed in field <code>excludeFields</code> will be ignored.
   *
  ...
  /**
   * Test if two <code>Object</code>s are equal using either #{@link #reflectionAppend(Object,
   * Object)}, if object are non primitives (or wrapper of primitives) or if field <code>
   * testRecursive</code> is set to <code>false</code>. Otherwise, using their <code>equals</code>
   * method.
   *
   * @param lhs the left hand object
   * @param rhs the right hand object
   ...
   * Returns <code>true</code> if the fields that have been checked are all equal.
   *
   * @return <code>true</code> if all of the fields that have been checked are equal, <code>false
   *     </code> otherwise.
   * @since 3.0
   */
  @Override
