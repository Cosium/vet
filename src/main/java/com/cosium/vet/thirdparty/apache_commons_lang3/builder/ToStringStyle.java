...
public abstract class ToStringStyle implements Serializable {
  ...
  /**
   * The default toString style. Using the <code>Person</code> example from {@link ToStringBuilder},
  ...
  /**
   * The simple toString style. Using the <code>Person</code> example from {@link ToStringBuilder},
   * the output would look like this:
   *
   * <pre>
   * John Doe,33,false
   ...
   *
   * <p>The size summary is used to summarize the contents of <code>Collections</code>, <code>Maps
   * </code> and arrays.
   *
  ...
  /**
   * <code>ToStringStyle</code> that does not print out the classname and identity hash code but
   * prints content start and field names.
   *
   * <p>This is an inner class rather than using <code>StandardToStringStyle</code> to ensure its
   * immutability.
   */
