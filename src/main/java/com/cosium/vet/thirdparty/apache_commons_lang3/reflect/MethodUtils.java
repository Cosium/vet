...
import com.cosium.vet.thirdparty.apache_commons_lang3.ClassUtils.Interfaces;
...
public class MethodUtils {
   ...
   * Invokes a named method without parameters.
   *
   * <p>This is a convenient wrapper for {@link #invokeMethod(Object object,boolean
  ...
  public static Method[] getMethodsWithAnnotation(
    ...
    final List<Method> annotatedMethodsList =
        getMethodsListWithAnnotation(cls, annotationCls, searchSupers, ignoreAccess);
  ...
  public static List<Method> getMethodsListWithAnnotation(
    ...
    final List<Class<?>> classes =
        (searchSupers ? getAllSuperclassesAndInterfaces(cls) : new ArrayList<Class<?>>());
    classes.add(0, cls);
   ...
   * ClassUtils#getAllInterfaces}(Class)}, one from superclasses, one from interfaces, and so on in
   * a breadth first way.
   *
   * @param cls the class to look up, may be {@code null}
   * @return the combined {@code List} of superclasses and interfaces in order going up from this
