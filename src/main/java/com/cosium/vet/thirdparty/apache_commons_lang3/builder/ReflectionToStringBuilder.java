 ...
 * private, the class uses {@link AccessibleObject#setAccessible(AccessibleObject[], boolean)} to
 ...
 *
 * <ul>
 *   <li>{@link #accept(Field)}
 *   <li>{@link #getValue(Field)}
 * </ul>
 *
...
public class ReflectionToStringBuilder extends ToStringBuilder {
  ...
  /**
   * Builds a <code>toString</code> value using the default <code>ToStringStyle</code> through
   * reflection.
   *
   ...
   * not be included. Superclass fields will be appended.
   *
   * <p>If the style is <code>null</code>, the default <code>ToStringStyle</code> is used.
   *
   * @param object the Object to be output
   * @param style the style of the <code>toString</code> to create, may be <code>null</code>
   * @return the String result
   * @throws IllegalArgumentException if the Object or <code>ToStringStyle</code> is <code>null
   *     </code>
   * @see ToStringExclude
   */
   ...
   * permissions are not set up correctly. It is also not as efficient as testing explicitly.
   *
   * <p>If the <code>outputTransients</code> is <code>true</code>, transient members will be output,
   ...
   * permissions are not set up correctly. It is also not as efficient as testing explicitly.
   *
   * <p>If the <code>outputTransients</code> is <code>true</code>, transient fields will be output,
   * otherwise they are ignored, as they are likely derived fields, and not part of the value of the
   * Object.
   *
   ...
   * superclass is treated as <code>java.lang.Object</code>.
   *
   * <p>If the style is <code>null</code>, the default <code>ToStringStyle</code> is used.
   *
   * @param <T> the type of the object
   ...
   * as if <code>Object.toString()</code> had been called and not implemented by the object.
   *
