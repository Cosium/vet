...
/**
 * The {@link Processor} represents a microprocessor and defines some properties like architecture
 * and type of the microprocessor.
 *
 * @since 3.6
 */
public class Processor {
  ...
  /**
   * Returns the processor architecture as an {@link Arch} enum. The processor architecture defines,
   * if the processor has a 32 or 64 bit architecture.
   *
  ...
  /**
   * Returns the processor type as {@link Type} enum. The processor type defines, if the processor
   * is for example a x86 or PPA.
   *
  ...
  /**
   * The {@link Arch} enum defines the architecture of a microprocessor. The architecture represents
   * the bit value of the microprocessor. The following architectures are defined:
   *
   * <ul>
   *   <li>32 bit
   *   <li>64 bit
  ...
  /**
   * The {@link Type} enum defines types of a microprocessor. The following types are defined:
   *
   * <ul>
   *   <li>x86
   *   <li>ia64
