...
public class InheritanceUtils {
  ...
  /**
   * {@link InheritanceUtils} instances should NOT be constructed in standard programming. Instead,
   * the class should be used as {@code MethodUtils.getAccessibleMethod(method)}.
   *
   ...
   * @return the number of generations between the child and parent; 0 if the same class; -1 if the
   *     classes are not related as child and parent (includes where either class is null)
   * @since 3.2
   */
