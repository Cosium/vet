 ...
 *
 * <p>According to <a
 * href="http://docs.oracle.com/javase/1.3/docs/api/java/lang/package-summary.html#charenc">JRE
 ...
 *
 * @see <a href="http://docs.oracle.com/javase/6/docs/technotes/guides/intl/encoding.doc.html">JRE
 *     character encoding names</a>
 * @since 2.1
 * @deprecated Java 7 introduced {@link java.nio.charset.StandardCharsets}, which defines these
 *     constants as {@link Charset} objects. Use {@link Charset#name()} to get the string values
 *     provided in this class. This class will be removed in a future release.
 */
@Deprecated
public class CharEncoding {
   ...
   *
   * @param name the name of the requested charset; may be either a canonical name or an alias, null
   *     returns false
   * @return {@code true} if the charset is available in the current Java virtual machine
   * @deprecated Please use {@link Charset#isSupported(String)} instead, although be aware that
   *     {@code null} values are not accepted by that method and an {@link
