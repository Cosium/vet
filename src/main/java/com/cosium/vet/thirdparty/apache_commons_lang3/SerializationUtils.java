...
public class SerializationUtils {
  ...
  /**
   * Custom specialization of the standard JDK {@link ObjectInputStream} that uses a custom <code>
   * ClassLoader</code> to resolve a class. If the specified <code>ClassLoader</code> is not able to
   ...
   * matter in which of the <code>ClassLoader</code> the particular class that encapsulates
  ...
  static class ClassLoaderAwareObjectInputStream extends ObjectInputStream {
    ...
    /**
     * Overridden version that uses the parameterized <code>ClassLoader</code> or the <code>
