 ...
 */
package com.cosium.vet.thirdparty.apache_commons_lang3.mutable;
...
public class MutableFloat extends Number implements Comparable<MutableFloat>, Mutable<Number> {
  ...
  // -----------------------------------------------------------------------
  /**
   * Compares this object against some other object. The result is <code>true</code> if and only if
   * the argument is not <code>null</code> and is a <code>Float</code> object that represents a
   * <code>float</code> that has the identical bit pattern to the bit pattern of the <code>float
   * </code> represented by this object. For this purpose, two float values are considered to be the
   * same if and only if the method {@link Float#floatToIntBits(float)}returns the same int value
   * when applied to each.
   *
   * <p>Note that in most cases, for two instances of class <code>Float</code>,<code>f1</code> and
   * <code>f2</code>, the value of <code>f1.equals(f2)</code> is <code>true</code> if and only if
   *
   * <blockquote>
   *
   * <pre>
   ...
   *       <code>equals</code> method returns <code>true</code>, even though <code>
   *       Float.NaN==Float.NaN</code> has the value <code>false</code>.
   *   <li>If <code>f1</code> represents <code>+0.0f</code> while <code>f2</code> represents <code>
   *       -0.0f</code>, or vice versa, the <code>equal</code> test has the value <code>false</code>
