...
public class ClassPathUtils {
  ...
  /**
   * {@code ClassPathUtils} instances should NOT be constructed in standard programming. Instead,
   * the class should be used as {@code ClassPathUtils.toFullyQualifiedName(MyClass.class,
   * "MyClass.properties");}.
   *
  ...
  /**
   * Returns the fully qualified name for the resource with name {@code resourceName} relative to
   * the given context.
   *
   * <p>Note that this method does not check whether the resource actually exists. It only
   * constructs the name. Null inputs are not allowed.
   *
   * <pre>
   * ClassPathUtils.toFullyQualifiedName(StringUtils.class, "StringUtils.properties") = "com.cosium.vet.thirdparty.apache_commons_lang3.StringUtils.properties"
   * </pre>
   *
   ...
   *
   * <pre>
   * ClassPathUtils.toFullyQualifiedName(StringUtils.class.getPackage(), "StringUtils.properties") = "com.cosium.vet.thirdparty.apache_commons_lang3.StringUtils.properties"
   * </pre>
   *
   * @param context The context for constructing the name.
   * @param resourceName the resource name to construct the fully qualified name for.
  ...
  /**
   * Returns the fully qualified path for the resource with name {@code resourceName} relative to
   * the given context.
   *
   * <p>Note that this method does not check whether the resource actually exists. It only
   * constructs the path. Null inputs are not allowed.
   *
   * <pre>
