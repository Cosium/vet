 ...
 * <code>UnsupportedOperationException</code> by providing a more semantically rich description of
 * the problem.
 *
 * <p><code>NotImplementedException</code> represents the case where the author has yet to implement
 * the logic at this point in the program. This can act as an exception based TODO tag.
 *
 * <pre>
 * public void foo() {
 *   try {
