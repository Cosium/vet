 ...
 *   <li><b>Equals/Compare</b> - compares two strings null-safe
 ...
 *   <li><b>Abbreviate</b> - abbreviates a string using ellipsis or another given String
...
public class StringUtils {
  ...
  /**
   * Compares given <code>string</code> to a CharSequences vararg of <code>searchStrings</code>,
   * returning {@code true} if the <code>string</code> is equal to any of the <code>searchStrings
   * </code>.
   *
   * <pre>
   ...
   *     searchStrings</code>; {@code false} if <code>searchStrings</code> is null or contains no
   *     matches.
   * @since 3.5
   */
  ...
  // -----------------------------------------------------------------------
  /**
   * Returns the index within <code>seq</code> of the first occurrence of the specified character.
   * If a character with value <code>searchChar</code> occurs in the character sequence represented
   * by <code>seq</code> <code>CharSequence</code> object, then the index (in Unicode code units) of
   * the first such occurrence is returned. For values of <code>searchChar</code> in the range from
   * 0 to 0xFFFF (inclusive), this is the smallest value <i>k</i> such that:
   *
   * <blockquote>
   *
   * <pre>
   ...
   * </blockquote>
   *
   * is true. In either case, if no such character occurs in <code>seq</code>, then {@code
   ...
   * represented by the <code>seq</code> <code>CharSequence</code> object at an index no smaller
   * than <code>startPos</code>, then the index of the first such occurrence is returned. For values
   * of <code>searchChar</code> in the range from 0 to 0xFFFF (inclusive), this is the smallest
   ...
   * </blockquote>
   *
   * is true. In either case, if no such character occurs in <code>seq</code> at or after position
   * <code>startPos</code>, then <code>-1</code> is returned.
   *
   * <p>There is no restriction on the value of <code>startPos</code>. If it is negative, it has the
   ...
   * {@code (INDEX_NOT_FOUND) -1} is returned. Furthermore, a {@code null} or empty ("")
   * CharSequence will return {@code (INDEX_NOT_FOUND) -1}.
   *
  ...
  // -----------------------------------------------------------------------
  /**
   * Returns the index within <code>seq</code> of the last occurrence of the specified character.
   * For values of <code>searchChar</code> in the range from 0 to 0xFFFF (inclusive), the index (in
   * Unicode code units) returned is the largest value <i>k</i> such that:
   *
   * <blockquote>
   *
   * <pre>
   ...
   * </blockquote>
   *
   * is true. In either case, if no such character occurs in this string, then <code>-1</code> is
   * returned. Furthermore, a {@code null} or empty ("") <code>CharSequence</code> will return
   * {@code -1}. The <code>seq</code> <code>CharSequence</code> object is searched backwards
   ...
   * <code>startPos</code>, then <code>-1</code> is returned. Furthermore, a {@code null} or empty
   * ("") <code>CharSequence</code> will return {@code -1}. A start position greater than the string
   * length searches the whole string. The search starts at the <code>startPos</code> and works
   ...
   * option is NOT automatically added. To use the DOTALL option prepend <code>"(?s)"</code> to the
   ...
   * prepend <code>"(?s)"</code> to the regex. DOTALL is also known as single-line mode in Perl.
   *
   * <pre>
   ...
   * "(?s)"</code> to the regex. DOTALL is also known as single-line mode in Perl.
   *
   * <pre>
  ...
  /**
   * Replaces a String with another String inside a larger String, for the first {@code max} values
   * of the search String, case sensitively/insensisitively based on {@code ignoreCase} value.
   *
   * <p>A {@code null} reference passed to this method is a no-op.
   *
   * <pre>
   ...
   * com.cosium.vet.thirdparty.apache_commons_lang3.text.WordUtils#capitalize(String)}. A {@code
   * null} input String returns {@code null}.
   *
   * <pre>
   ...
   * @see com.cosium.vet.thirdparty.apache_commons_lang3.text.WordUtils#capitalize(String)
   ...
   *
   * <p>For a word based algorithm, see {@link
   * com.cosium.vet.thirdparty.apache_commons_lang3.text.WordUtils#uncapitalize(String)}. A {@code
   * null} input String returns {@code null}.
   *
   * <pre>
   ...
   * @see com.cosium.vet.thirdparty.apache_commons_lang3.text.WordUtils#uncapitalize(String)
   ...
   *
   * <p>For a word based algorithm, see {@link
   * com.cosium.vet.thirdparty.apache_commons_lang3.text.WordUtils#swapCase(String)}. A {@code null}
   ...
   * com.cosium.vet.thirdparty.apache_commons_lang3.text.WordUtils.
   *
   ...
   *
   * <p>For example, <code>
   * indexOfDifference(new String[] {"i am a machine", "i am a robot"}) -&gt; 7</code>
   *
   * <pre>
