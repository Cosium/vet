...
import com.cosium.vet.thirdparty.apache_commons_lang3.builder.EqualsBuilder;
import com.cosium.vet.thirdparty.apache_commons_lang3.builder.HashCodeBuilder;
import com.cosium.vet.thirdparty.apache_commons_lang3.builder.ToStringBuilder;
import com.cosium.vet.thirdparty.apache_commons_lang3.builder.ToStringStyle;
import com.cosium.vet.thirdparty.apache_commons_lang3.math.NumberUtils;
import com.cosium.vet.thirdparty.apache_commons_lang3.mutable.MutableInt;
...
public class ArrayUtils {
  ...
  // -----------------------------------------------------------------------
  /**
   * Converts the given array into a {@link Map}. Each element of the array must be either a {@link
   * Map.Entry} or an Array, containing at least two elements, where the first element is used as
   * key and the second as value.
   *
   ...
   *
   * @param array an array whose elements are either a {@link Map.Entry} or an Array containing at
   *     least two elements, may be {@code null}
   ...
   * @throws IllegalArgumentException if the array contains elements other than {@link Map.Entry}
   *     and an Array
   */
   ...
   * explicitly like in <code>
   * Number[] array = ArrayUtils.&lt;Number&gt;toArray(Integer.valueOf(42), Double.valueOf(Math.PI))
   * </code>, there is no real advantage when compared to <code>
   * new Number[] {Integer.valueOf(42), Double.valueOf(Math.PI)}</code>.
   *
   ...
   * </code> will be returned if the input array is <code>null</code>.
   *
