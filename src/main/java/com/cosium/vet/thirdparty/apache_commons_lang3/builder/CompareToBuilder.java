 ...
 *
 * <p>It is consistent with <code>equals(Object)</code> and <code>hashcode()</code> built with
 * {@link EqualsBuilder} and {@link HashCodeBuilder}.
 *
 * <p>Two Objects that compare equal using <code>equals(Object)</code> should normally also compare
 * equal using <code>compareTo(Object)</code>.
 *
 ...
 * compareTo(Object)</code> and <code>equals(Object)</code>.
 *
 ...
 * reflectionCompare</code> uses {@link AccessibleObject#setAccessible(boolean)} to bypass normal
 ...
 *
 * <p>A typical implementation of <code>compareTo(Object)</code> using <code>reflectionCompare
 * </code> looks like:
 *
 * <pre>
 * public int compareTo(Object o) {
...
public class CompareToBuilder implements Builder<Integer> {
   ...
   *
   * <p>Fields can be private, thus <code>AccessibleObject.setAccessible</code> is used to bypass
   ...
   * </ul>
   *
   * <p>If both <code>lhs</code> and <code>rhs</code> are <code>null</code>, they are considered
   * equal.
   *
   * @param lhs left-hand object
   * @param rhs right-hand object
   * @return a negative integer, zero, or a positive integer as <code>lhs</code> is less than, equal
   *     to, or greater than <code>rhs</code>
   * @throws NullPointerException if either (but not both) parameters are <code>null</code>
   * @throws ClassCastException if <code>rhs</code> is not assignment-compatible with <code>lhs
   *     </code>
   */
   ...
   *       Otherwise ignores them, as they are likely derived fields.
   *   <li>Superclass fields will be compared
   * </ul>
   *
   * <p>If both <code>lhs</code> and <code>rhs</code> are <code>null</code>, they are considered
   ...
   * @return a negative integer, zero, or a positive integer as <code>lhs</code> is less than, equal
   *     to, or greater than <code>rhs</code>
   * @throws NullPointerException if either <code>lhs</code> or <code>rhs</code> (but not both) is
   *     <code>null</code>
   * @throws ClassCastException if <code>rhs</code> is not assignment-compatible with <code>lhs
   *     </code>
   */
   ...
   *       Otherwise ignores them, as they are likely derived fields.
   *   <li>Compares superclass fields up to and including <code>reflectUpToClass</code>. If <code>
   *       reflectUpToClass</code> is <code>null</code>, compares all superclass fields.
   * </ul>
   *
   * <p>If both <code>lhs</code> and <code>rhs</code> are <code>null</code>, they are considered
   * equal.
   ...
   *
   * <ol>
   *   <li>Check if <code>lhs == rhs</code>
   *   <li>Check if either <code>lhs</code> or <code>rhs</code> is <code>null</code>, a <code>null
   *       </code> object is less than a non-<code>null</code> object
   *   <li>Check the object contents
   * </ol>
   *
   * <p><code>lhs</code> must either be an array or implement {@link Comparable}.
   *
   * @param lhs left-hand object
   * @param rhs right-hand object
   * @return this - used to chain append calls
   ...
   * </ol>
   *
   * <p>If <code>lhs</code> is an array, array comparison methods will be used. Otherwise <code>
   * comparator</code> will be used to compare the objects. If <code>comparator</code> is <code>null
   * </code>, <code>lhs</code> must implement {@link Comparable} instead.
   *
   * @param lhs left-hand object
   * @param rhs right-hand object
   * @param comparator <code>Comparator</code> used to compare the objects, <code>null</code> means
   *     treat lhs as <code>Comparable</code>
   * @return this - used to chain append calls
   * @throws ClassCastException if <code>rhs</code> is not assignment-compatible with <code>lhs
   *     </code>
   * @since 2.0
   ...
   *   <li>Check if for <code>null</code>, <code>null</code> is less than non-<code>null</code>
   ...
   * @param lhs left-hand array
   * @param rhs right-hand array
   * @param comparator <code>Comparator</code> to use to compare the array elements, <code>null
   *     </code> means to treat <code>lhs</code> elements as <code>Comparable</code>.
   * @return this - used to chain append calls
   * @throws ClassCastException if <code>rhs</code> is not assignment-compatible with <code>lhs
   *     </code>
   * @since 2.0
  ...
  // -----------------------------------------------------------------------
  /**
   * Returns a negative integer, a positive integer, or zero as the <code>builder</code> has judged
